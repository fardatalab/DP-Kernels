...
#ifdef DPK_ACTIVE
static constexpr size_t VALUE_SIZE = __UNCOMPRESSED_SIZE;
#else
...
class PageServer
{
  ...
  private:
    ...
    void PollDDSCompletions(ClientState *client_state);
  ...
  private:
    ...
    DDS_FrontEnd::DDSFrontEnd* store_;
    std::vector<FileIdT> seg_file_ids_;
    // page index
    ...
    struct ClientState
    {
        ...
        std::queue<char*> scratch_buffers_;
        // char *scratch;
