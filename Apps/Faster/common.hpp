...
#define UNCOMPRESSED_SIZE (1 * KB)
#define COMPRESSED_SIZE (531)
...
#define BASELINE // if defined, no decompression is performed, i.e. server sends out msg header

#ifdef BASELINE
#define INPUT_FILE "/data/jason/txt/1K.txt"
#else
#define INPUT_FILE "/data/jason/deflate/1K.deflate"
#endif
