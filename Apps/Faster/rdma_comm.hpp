...
extern vector<RDMAConnectionResource> connections;
...
int rdma_send(int thread_idx, u_int32_t data_size);
...
inline u_int8_t *get_send_buffer(int thread_idx, int idx)
{
    ...
    //     return nullptr;
    // }
    auto &conn = connections[thread_idx];
