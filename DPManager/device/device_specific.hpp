...
typedef bool (*register_executors_func)(dpm_task_executor global_executors[DEVICE_LAST][TASK_NAME_LAST]);
extern "C" bool dpm_register_executors(dpm_task_executor global_executors[DEVICE_LAST][TASK_NAME_LAST]);
...
bool dpm_load_kernels(void *handle, dpm_task_executor global_executors[DEVICE_LAST][TASK_NAME_LAST]);
