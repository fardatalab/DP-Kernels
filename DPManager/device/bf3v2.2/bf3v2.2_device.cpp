...
bool dpm_register_executors(dpm_task_executor global_executors[DEVICE_LAST][TASK_NAME_LAST])
{
    ...
    global_executors[DEVICE_BLUEFIELD_3][TASK_DECOMPRESS_DEFLATE] = (struct dpm_task_executor){
        ...
        .get_estimated_completion_time = bf3v2_2_decompress_deflate_kernel_get_estimated_completion_time};
