...
#define DPM_INPUT_SHM_SIZE (((size_t)1 * GB))  // 2GB
#define DPM_OUTPUT_SHM_SIZE (((size_t)1 * GB)) // 2GB
// #define DPM_SHM_IO_BUF_SIZE 2 * 1024 * 1024 * 1024 // 2GB
#define DPM_REQ_CTX_SHM_SIZE 1 * 1024 * 1024 * 1024 // 1GB

#define DPM_DOCA_WORKQ_DEPTH 4096 // probably move this somewhere else

// the parameter when initializing DOCA mem, max doca_bufs allowed in the inventory
#define DPM_DOCA_MAX_BUF 4096 // 8192
