...
/// using boost's message queue, submit a task to the DPManager.
...
extern std::mutex heap_alloc_mutex; // Add this line
...
inline shm_ptr get_shm_ptr_for_mem_req_ctx(char *buf)
{
