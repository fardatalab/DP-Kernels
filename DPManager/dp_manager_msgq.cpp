...
{
    dpm_submission_queue_ring_buffer = AllocateRequestBufferProgressive();
...
dpkernel_error dpm_poll_requests()
{
    ...
    if (FetchFromRequestBufferProgressive(dpm_submission_queue_ring_buffer, req_ring_buffer_holder, &req_size))
    {
