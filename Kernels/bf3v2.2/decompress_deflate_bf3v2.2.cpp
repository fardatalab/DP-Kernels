...
struct dpm_doca_decompress_deflate_bf3v2_2 bf3v2_2_decompress_deflate_state;
...
dpkernel_error bf3v2_2_decompress_deflate_kernel_execute(dpkernel_task_base *task)
{
    ...
    decompress_job = {
        .base =
            (struct doca_job){
                ...
                .ctx = bf3v2_2_decompress_deflate_state.ctx,
    ...
    ret = doca_workq_submit(bf3v2_2_decompress_deflate_state.workq, &decompress_job.base);
...
dpkernel_error bf3v2_2_decompress_deflate_kernel_poll(dpkernel_task_base *task)
{
    ...
    ret = doca_workq_progress_retrieve(bf3v2_2_decompress_deflate_state.workq, &event, DOCA_WORKQ_RETRIEVE_FLAGS_NONE);
