...
/// Default reserves cores 0..5 for DDS app/workers/agent (app=0, workers=1..4, agent=5).
#ifndef DPK_THREAD_PIN_BASE_CORE
// Original 2-worker baseline default retained for reference:
// #define DPK_THREAD_PIN_BASE_CORE 4
#define DPK_THREAD_PIN_BASE_CORE 6
#endif
