...
#define TEST_USE_MEMCPY        // pass not the pointers to payload buffers, but copy
...
#define DPM_SUBMISSION_QUEUE_SIZE 4096 // TODO: dynamic? parameter?

#define MPMC_QUEUE_NUMBER 15
